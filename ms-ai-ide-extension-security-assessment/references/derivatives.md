...
- **SBOM-style inventory:** use CycloneDX or SPDX when a valid component inventory supports it; otherwise label the output “SBOM-style inventory,” not an SBOM. Include component, version, supplier, hashes, licences, dependency relationship, scope, evidence, and unknowns.
- **Concise executive report:** derive from the detailed report; retain decision, scope/version, top five outcomes, highest residual risks, conditions, limitations, and next review trigger.

Validate PPTX/XLSX/DOCX/PDF outputs with their applicable skill workflow. Check formulas/types, links, render/layout, accessibility, metadata, and consistency with the authoritative report.
