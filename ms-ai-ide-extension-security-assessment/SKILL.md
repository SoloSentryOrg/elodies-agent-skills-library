...
7. **Assess threats and controls.** Use [references/frameworks.md](references/frameworks.md), checking current framework versions and applicability. Map evidence to OWASP LLM, OWASP Agentic AI, OWASP MCP when applicable, MITRE ATLAS, NIST AI RMF, OWASP ASVS, CIS Controls, ISO/IEC 27001 Annex A, NCSC secure-AI guidance, privacy/data protection, and applicable FCA/PRA/UK financial- and insurance-sector obligations.
